 ...
 * - in `[1, 2, 3]` into CT::T_ARRAY_TRANSACTPRO_BRACE_OPEN and CT::T_ARRAY_TRANSACTPRO_BRACE_CLOSE,
 * - in `[$a, $b, $c] = array(1, 2, 3)` into CT::T_DESTRUCTURING_TRANSACTPRO_BRACE_OPEN and CT::T_DESTRUCTURING_TRANSACTPRO_BRACE_CLOSE.
 *
...
final class SquareBraceTransformer extends AbstractTransformer
{
    ...
    {
        return [
            CT::T_ARRAY_TRANSACTPRO_BRACE_OPEN,
            CT::T_ARRAY_TRANSACTPRO_BRACE_CLOSE,
            CT::T_DESTRUCTURING_TRANSACTPRO_BRACE_OPEN,
            CT::T_DESTRUCTURING_TRANSACTPRO_BRACE_CLOSE,
        ];
    }
    ...
    {
        $endIndex = $tokens->findBlockEnd(Tokens::BLOCK_TYPE_INDEX_TRANSACTPRO_BRACE, $index);

        $tokens[$index] = new Token([CT::T_ARRAY_TRANSACTPRO_BRACE_OPEN, '[']);
        $tokens[$endIndex] = new Token([CT::T_ARRAY_TRANSACTPRO_BRACE_CLOSE, ']']);
    }
    ...
    private function transformIntoDestructuringSquareBrace(Tokens $tokens, $index)
    {
        ...
        $tokens[$index] = new Token([CT::T_DESTRUCTURING_TRANSACTPRO_BRACE_OPEN, '[']);
        $tokens[$endIndex] = new Token([CT::T_DESTRUCTURING_TRANSACTPRO_BRACE_CLOSE, ']']);
    }
