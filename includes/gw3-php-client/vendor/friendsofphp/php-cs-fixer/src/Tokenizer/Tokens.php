...
class Tokens extends \SplFixedArray
{
    ...
    const BLOCK_TYPE_INDEX_TRANSACTPRO_BRACE = 3;
    const BLOCK_TYPE_ARRAY_TRANSACTPRO_BRACE = 4;
    ...
    const BLOCK_TYPE_DESTRUCTURING_TRANSACTPRO_BRACE = 9;
    ...
    public static function getBlockEdgeDefinitions()
    {
        return [
            ...
            self::BLOCK_TYPE_INDEX_TRANSACTPRO_BRACE => [
                'start' => '[',
                'end' => ']',
            ],
            self::BLOCK_TYPE_ARRAY_TRANSACTPRO_BRACE => [
                'start' => [CT::T_ARRAY_TRANSACTPRO_BRACE_OPEN, '['],
                'end' => [CT::T_ARRAY_TRANSACTPRO_BRACE_CLOSE, ']'],
            ],
            ...
            self::BLOCK_TYPE_DESTRUCTURING_TRANSACTPRO_BRACE => [
                'start' => [CT::T_DESTRUCTURING_TRANSACTPRO_BRACE_OPEN, '['],
                'end' => [CT::T_DESTRUCTURING_TRANSACTPRO_BRACE_CLOSE, ']'],
            ],
