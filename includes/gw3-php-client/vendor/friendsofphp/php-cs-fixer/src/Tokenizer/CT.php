...
final class CT
{
    ...
    const T_ARRAY_TRANSACTPRO_BRACE_CLOSE = 10003;
    const T_ARRAY_TRANSACTPRO_BRACE_OPEN = 10004;
    ...
    const T_DESTRUCTURING_TRANSACTPRO_BRACE_CLOSE = 10011;
    const T_DESTRUCTURING_TRANSACTPRO_BRACE_OPEN = 10012;
