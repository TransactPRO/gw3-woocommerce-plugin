...
final class ListSyntaxFixer extends AbstractFixer implements ConfigurationDefinitionFixerInterface
{
    ...
    public function configure(array $configuration = null)
    {
        ...
        $this->candidateTokenKind = 'long' === $this->configuration['syntax'] ? CT::T_DESTRUCTURING_TRANSACTPRO_BRACE_OPEN : T_LIST;
    }
    ...
    private function fixToLongSyntax(Tokens $tokens, $index)
    {
        ...
        if (!$tokens[$closeIndex]->isGivenKind(CT::T_DESTRUCTURING_TRANSACTPRO_BRACE_CLOSE)) {
            return;
        }
    ...
    private function fixToShortSyntax(Tokens $tokens, $index)
    {
        ...
        $tokens[$openIndex] = new Token([CT::T_DESTRUCTURING_TRANSACTPRO_BRACE_OPEN, '[']);
        $tokens[$closeIndex] = new Token([CT::T_DESTRUCTURING_TRANSACTPRO_BRACE_CLOSE, ']']);
