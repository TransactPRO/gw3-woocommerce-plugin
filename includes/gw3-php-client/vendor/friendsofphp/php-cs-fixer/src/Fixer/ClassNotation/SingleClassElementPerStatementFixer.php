...
',
        ...
        while (true) {
            ...
            if ($tokensAnalyzer->isArray($repeatIndex)) {
                if ($repeatToken->isGivenKind(T_ARRAY)) {
                    ...
                    $repeatIndex = $tokens->findBlockEnd(Tokens::BLOCK_TYPE_ARRAY_TRANSACTPRO_BRACE, $repeatIndex);
                }
    ...
    private function expandElement(Tokens $tokens, $startIndex, $endIndex)
    {
        ...
        for ($i = $endIndex - 1; $i > $startIndex; --$i) {
            ...
            if ($token->isGivenKind(CT::T_ARRAY_TRANSACTPRO_BRACE_CLOSE)) {
                $i = $tokens->findBlockEnd(Tokens::BLOCK_TYPE_ARRAY_TRANSACTPRO_BRACE, $i, false);
