...
final class ArraySyntaxFixer extends AbstractFixer implements ConfigurationDefinitionFixerInterface
{
    ...
    {
        $closeIndex = $tokens->findBlockEnd(Tokens::BLOCK_TYPE_ARRAY_TRANSACTPRO_BRACE, $index);
    ...
    private function fixToShortArraySyntax(Tokens $tokens, $index)
    {
        ...
        $tokens[$openIndex] = new Token([CT::T_ARRAY_TRANSACTPRO_BRACE_OPEN, '[']);
        $tokens[$closeIndex] = new Token([CT::T_ARRAY_TRANSACTPRO_BRACE_CLOSE, ']']);
    ...
    {
        $this->candidateTokenKind = 'long' === $this->configuration['syntax'] ? CT::T_ARRAY_TRANSACTPRO_BRACE_OPEN : T_ARRAY;
    }
}
