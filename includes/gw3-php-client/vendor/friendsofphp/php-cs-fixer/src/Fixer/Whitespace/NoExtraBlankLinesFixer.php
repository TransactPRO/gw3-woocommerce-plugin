...
final class NoExtraBlankLinesFixer extends AbstractFixer implements ConfigurationDefinitionFixerInterface, WhitespacesAwareFixerInterface
{
    ...
    public function configure(array $configuration = null)
    {
        ...
        static $reprToTokenMap = [
            ...
            'parenthesis_brace_block' => '(',
            'return' => T_RETURN,
            'square_brace_block' => CT::T_ARRAY_TRANSACTPRO_BRACE_OPEN,
            'switch' => T_SWITCH,
            'throw' => T_THROW,
            'use' => T_USE,
        ...
        static $tokenKindCallbackMap = [
            ...
            CT::T_ARRAY_TRANSACTPRO_BRACE_OPEN => 'fixStructureOpenCloseIfMultiLine', // typeless '[' tokens should not be fixed (too rare)
        ];
